...
public class StringEntity
  ...
  implements Cloneable {
     ...
     * @param charset character set to be used. May be {@code null}, in which case the default is {@link
     *   HTTP#DEF_CONTENT_CHARSET} i.e. "ISO-8859-1"
     *
     ...
     * @param string content to be used. Not {@code null}.
     * @param charset character set to be used. May be {@code null}, in which case the default is {@link
     *   HTTP#DEF_CONTENT_CHARSET} is assumed
     *
     * @throws IllegalArgumentException if the string parameter is null
     * @throws UnsupportedCharsetException Thrown when the named charset is not available in this instance
     *   of the Java virtual machine
    ...
    /**
     * Creates a StringEntity with the specified content. The content type defaults to {@link
