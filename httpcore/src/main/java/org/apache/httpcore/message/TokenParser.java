...
/**
 * Low level parser for header field elements. The parsing routines of this class are designed to produce near
 * zero intermediate garbage and make no intermediate copies of input data. <p> This class is immutable and
 * thread safe.
 *
 * @since 4.4
 */
...
public class TokenParser {
    ...
    /**
     * Extracts from the sequence of chars a token terminated with any of the given delimiters discarding
     * semantically insignificant whitespace characters.
     *
     ...
     * @param delimiters set of delimiting characters. Can be {@code null} if the token is not delimited by
     *   any character.
     */
    ...
    /**
     * Extracts from the sequence of chars a value which can be enclosed in quote marks and terminated with
     * any of the given delimiters discarding semantically insignificant whitespace characters.
     *
     * @param buf buffer with the sequence of chars to be parsed
     * @param cursor defines the bounds and current position of the buffer
     * @param delimiters set of delimiting characters. Can be {@code null} if the value is not delimited by
     *   any character.
     */
    ...
    /**
     * Transfers content into the destination buffer until a whitespace character or any of the given
     * delimiters is encountered.
     *
     * @param buf buffer with the sequence of chars to be parsed
     * @param cursor defines the bounds and current position of the buffer
     * @param delimiters set of delimiting characters. Can be {@code null} if the value is delimited by a
     *   whitespace only.
    ...
    /**
     * Transfers content into the destination buffer until a whitespace character,  a quote, or any of the
     * given delimiters is encountered.
     *
     * @param buf buffer with the sequence of chars to be parsed
     * @param cursor defines the bounds and current position of the buffer
     * @param delimiters set of delimiting characters. Can be {@code null} if the value is delimited by a
     *   whitespace or a quote only.
     * @param dst destination buffer
     */
