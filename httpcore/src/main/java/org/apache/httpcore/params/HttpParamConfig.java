    ...
    public static ConnectionConfig getConnectionConfig(final HttpParams params) {
        ...
        return ConnectionConfig.custom()
          ...
          .setMalformedInputAction(
            (CodingErrorAction)params.getParameter(CoreProtocolPNames.HTTP_MALFORMED_INPUT_ACTION))
          .setMalformedInputAction(
            (CodingErrorAction)params.getParameter(CoreProtocolPNames.HTTP_UNMAPPABLE_INPUT_ACTION))
