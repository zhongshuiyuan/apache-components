...
public interface HttpServerConnection
  extends HttpConnection {
    ...
    /**
     * Receives the request line and all headers available from this connection. The caller should examine the
     * returned request and decide if to receive a request entity as well.
     *
     * @return a new HttpRequest object whose request line and headers are initialized.
     *
    ...
    /**
     * Receives the next request entity available from this connection and attaches it to an existing
     * request.
     *
