...
public interface HttpResponseFactory {
     ...
     * @param context the context from which to determine the locale for looking up a reason phrase to the
     *   status code, or {@code null} to use the default locale
     *
     ...
     * @param context the context from which to determine the locale for looking up a reason phrase if the
     *   status code is updated, or {@code null} to use the default locale
     *
