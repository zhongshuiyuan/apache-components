...
/**
 * English reason phrases for HTTP status codes. All status codes defined in RFC1945 (HTTP/1.0), RFC2616
 * (HTTP/1.1), and RFC2518 (WebDAV) are supported.
 *
 * @since 4.0
 */
...
public class EnglishReasonPhraseCatalog
  implements ReasonPhraseCatalog {
    ...
    /**
     * The default instance of this catalog. This catalog is thread safe, so there typically is no need to
    ...
    /**
     * Restricted default constructor, for derived classes. If you need an instance of this class, use {@link
     * #INSTANCE INSTANCE}.
     */
