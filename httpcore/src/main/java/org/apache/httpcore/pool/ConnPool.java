...
/**
 * {@code ConnPool} represents a shared pool connections can be leased from and released back to.
 *
...
public interface ConnPool<T, E> {
     ...
     * @param reusable flag indicating whether or not the released connection is in a consistent state and
     *   is safe for further use.
     */
