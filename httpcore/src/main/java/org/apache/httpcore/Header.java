 ...
 *
 * <p>The HTTP header fields follow the same generic format as that given in Section 3.1 of RFC 822. Each
 * header field consists of a name followed by a colon (":") and the field value. Field names are
 * case-insensitive. The field value MAY be preceded by any amount of LWS, though a single SP is preferred.
 *
 * <pre>
